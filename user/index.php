        ...
        ?>
          <div class="item">
            <div class="kategori-item text-dark bg-white w-100 m-2 transition-5s">
              <a href="<?= $base_url ?>user/daftar-event.php?id=<?= $resultKategori['id_kategoriwebinar']?>&&kategori=<?=$resultKategori['nama_kategoriwebinar']?>" class="text-dark text-decoration-none">
    ...
    <section class="mt-4">
      <div class="event-terdekat text-dark">
          ...
          <div class="event-webinar text-dark bg-white p-3 p-lg-5">
            <div class="position-relative">
              <div class="row">
                <a href="detail-event.php?id=<?=$resultEvent['id_event']?>" class="col-md-4 col-12">
                  <img src="<?= $base_url ?>assets/img/<?=$resultEvent['gambar_event']?>" alt="<?= $resultEvent['gambar_event'] ?>" class="w-100">
                </a>
                <div class="col-md-8 d-md-block d-none">
                  <button disabled class="tag-webinar">
                  ...
                  <a class="text-primary mt-4" href="detail-event.php?id=<?=$resultEvent['id_event']?>" style="text-decoration: none;">
                    <h3>
                      <?= $resultEvent['judul_event'] ?>
                    </h3>
                  </a>
                  ...
                  <div class="position-absolute d-md-block d-none" style="bottom: 15px">
                    ...
                    <a style="background-color: #52A6BE;" class="text-white px-3 py-1 text-decoration-none rounded-pill" href="detail-event.php?id=<?=$resultEvent['id_event']?>">
                      Detail Lainnya <i class="fas fa-arrow-right ms-3"></i>
                    </a>
                  </div>
                </div>
