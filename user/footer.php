        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-3 col-md-6 ms-lg-5 mb-2">
              ...
              <ul class="hubungi-kami">
                <li class="d-block">
                  <a href="javascript:void(0)" style="text-decoration: none; color: black">Kebijakan Privasi</a>
                </li>
                <li class="d-block">
                  <a href="javascript:void(0)" style="text-decoration:none; color: black">Syarat dan Ketentuan Umum</a>
                </li>
              </ul>
            </div>
        </div>
