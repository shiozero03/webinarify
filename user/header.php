<?php
  ...
  $queryAdmin = mysqli_query($conn, "SELECT * FROM user WHERE id_user =  1");
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link transition-5s mx-lg-2 text-lg-start text-center" href="<?= $base_url ?>user">Beranda</a>
            </li>
            <li class="nav-item">
              <a class="nav-link transition-5s mx-lg-2 text-lg-start text-center" href="javascript:void(0)" onclick="this.href='#'">Kontak Kami</a>
            </li>
            <li class="nav-item">
              <a class="nav-link transition-5s bg-secondary rounded px-lg-3 mx-lg-2 text-lg-start text-center" href="<?= $base_url ?>user/profil.php" ><?= $resUser['username'] ?></a>
            </li>
            <li class="nav-item">
              <a href="javascript:void(0)" target="__blank" onclick="this.href='https://wa.me/<?= $resAdmin['whatsapp_admin'] ?>?text=Halo admin, saya ingin mengupgrade akun saya atas email <?= $resUser['email_user'] ?>'" class="nav-link transition-5s bg-primary rounded px-lg-3 mx-lg-2 text-lg-start text-center"><i class="fas fa-crown text-warning me-2"></i>Get Premium</a>
            </li>
          </ul>
        </div>
      </div>
